      ...
      <main>
        ...
        <div className="row g-3">
          <div className="col-md-5 col-lg-4 order-md-last">
            ...
            <ul className="list-group mb-3">
              ...
              <li className="list-group-item d-flex justify-content-between lh-sm">
                ...
                <span className="text-muted">-${order.total_cost * order.discontIn_percent / 100}</span>
              </li>


              <li className="list-group-item d-flex justify-content-between">
                <span>Total (USD)</span>
                <strong>${order.total_cost - order.total_cost * order.discontIn_percent / 100 + order.shipping_Charge}</strong>
              </li>
            </ul>
          ...
          <div className="col-md-7 col-lg-8">
            ...
            <form className="needs-validation"  onSubmit={(e) => { e.preventDefault(); validateAddress(address); }}>
              <div className="row g-3">
